...
namespace GameTools.MeteredUsageAccess
{
    ...
    public interface IQuotaAccess
    {
        ...
        OpResult<UserQuota> LoadUserQuota(string userId) 
            => LoadUserQuotaAsync(userId).Result;
        ...
        OpResult<UserQuota> ConsumeQuota(int quotaId, int amountConsumed, string? userId = "") 
        ...
        Task<OpResult<UserQuota>> ConsumeQuotaAsync(int quotaId, int amountConsumed, string? userId = "");

        OpResult<UserQuota> ReleaseQuota(int quotaId, int amounReleased, string? userId = "") 
            => ReleaseQuotaAsync(quotaId, amounReleased, userId).Result;
        ...
        Task<OpResult<UserQuota>> ReleaseQuotaAsync(int quotaId, int amountReleased, string? userId = "");
